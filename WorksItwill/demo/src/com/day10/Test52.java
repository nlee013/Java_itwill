...
public class Test52 {
	...
	public static void main(String[] args) {
		...
		String[] ss = s1.split(",");//쉼표로 나눠라
		//배열 : new 하거나 {,,,};방법이 있었다
		
		for(String s : ss) 
			//System.err.print(s + " ");//-> 빨간색 글씨로 출력.아마도 error 정보 출력인듯
			System.out.print(s + " ");//한 칸씩 띄어서 출력됨
			
			String s2 = "seoul";
			String s3 = "Seoul";
			System.out.println(s2.equals(s3));//false->대소문자 비교시 다르므로 false
			...
			System.out.println(s4.lastIndexOf("."));//7 -> 뒤에서부터 점이 들어간 index 값을 찾아와라
			...
			String s7 = "  a b c  ";//양 쪽 공간에 띄어쓰기 2칸한 상태//공백도 string
